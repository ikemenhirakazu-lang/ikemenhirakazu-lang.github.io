...
pubDate: '2026-07-28'
heroImage: '../../assets/blog/episode-5-kouhen/00-hero.png'
heroImageAlt: '明るい部屋のテーブルで、気まずそうに横を向いているボスと、チェックリストに鉛筆を走らせながら厳しい目を向けている丸メガネの黒猫クロさん。「AIに「褒めるな」と言う監査役を、自分で作った——実装しない・褒めない・前提を疑う」'
category: tsukutta
series: main
episode: 5.5
draft: false
...
![やった対策3つ。指示書に目的を書く、監査役を常設する、公開後のサイトを見に行かせる。それぞれが前編で聞いた4つの理由のどれを消すのかを添えた図](../../assets/blog/episode-5-kouhen/01-yatta-taisaku.png)
...
![監査役に決めた3つのルール。実装しない、褒めない、前提を疑う。呼び出しは「blog-auditor で監査してください」の1行だけ、という図](../../assets/blog/episode-5-kouhen/02-kansayaku-no-rule.png)
